...
<span class="tag tag-green">Monarch AMC &middot; Rs `{python} AUM_CR` Cr AUM (Hypothetical)</span>
<span class="tag tag-amber">Benchmark: Nifty 50 &nbsp;|&nbsp; `{python} n_stocks` Holdings</span>
</p>
<p style="margin-top:14px; color:#34495e;">
India's energy transition is the largest capital reallocation event of this decade. The government has committed to <strong>500 GW of non-fossil capacity by 2030</strong>, implying Rs 25&ndash;30 lakh crore of infrastructure investment over six years. This fund captures that structural shift across the full value chain &mdash; renewable developers, grid utilities, industrial capital goods and EPC, energy-efficient systems, and water infrastructure.
</p>
...
<p style="font-size:0.83em; color:#7f8c8d; margin-top:12px;">
<strong>Team Mountains &amp; Accretions</strong> &nbsp;&middot;&nbsp; IIM Indore &nbsp;&middot;&nbsp;
IIM-A Launchpad Alpha 2026 &nbsp;&middot;&nbsp; Data through `{python} data_end`
</p>
</div>
